...
const RussiaData={
    ...
    countryWhyChoseSection:{
        Description:"Russia has cemented its reputation as a global hub for medical education, attracting thousands of Indian students annually. The country’s 50+ MCI/NMC-approved universities offer a unique blend of affordability, world-class infrastructure, and globally recognized degrees.",
        ImageSrc:"/assets/Images/CountryBlogs/Russia1.webp",
        ImageAlt:"Russia Image"
    },
    countrySpecificSection1:true,
    countryCostData:{
