...
const Bachelors = () => {
  return (
    <>
    <Head>
    <title>Study Bachelors in Germany for Free | Top Universities for International Students</title>
<meta name="keywords" content="study in germany for free, free education in germany for bachelors, german language course, universities in germany for international students, scholarships in germany, bachelor degree in germany, top universities in germany, study bachelors in germany, bachelors in germany for indian students" />
<meta name="description" content="Pursue a bachelor’s degree in Germany with free or low tuition fees. Get admission guidance, scholarships, and language course details https://www.edurizon.in/study-destinations/study-in-germany/bachelors-in-germany." />
<meta name="author" content="edurizon" />
<meta name="robots" content="index, follow" />
<meta name="DC.title" content="Study Bachelors in Germany for Free" />
<meta name="geo.region" content="IN-DL" />
<meta name="geo.placename" content="Dwarka" />
<meta name="geo.position" content="22.351115;78.667743" />
<meta name="ICBM" content="22.351115, 78.667743" />
<meta property="og:type" content="website" />
<meta property="og:title" content="Study Bachelors in Germany for Free | Top Universities for International Students" />
<meta property="og:description" content="Pursue a bachelor’s degree in Germany with free or low tuition fees. Get admission guidance, scholarships, and language course details https://www.edurizon.in/study-destinations/study-in-germany/bachelors-in-germany." />
<meta property="og:url" content="https://www.edurizon.in/study-destinations/study-in-germany/bachelors-in-germany" />
...
<meta name="twitter:title" content="Study Bachelors in Germany for Free | Top Universities for International Students" />
...
></script>
    ...
    <div className='flex flex-col mx-[6vw] md:mx-[12.5vw] items-center pt-[20vw]  md:pt-[8vw] md:pb-[3vw] gap-[4vw] md:gap-[4vw]  '>
        ...
        <div className='flex flex-col gap-[1vw] w-full'>
            ...
            <p className='text-regularTextPhone md:text-regularText leading-[130%]'>If students do not have any diploma, minimum of 1 year, they will have to complete 1 year foundation course in Germany that is called Studien kolleg.</p>
        ...
        <div className='flex flex-col gap-[1vw] w-full'>
            ...
            <ul className='list-disc pl-[6vw] md:pl-[1.5vw] font-medium list-outside md:text-regularText text-regularTextPhone '>
                ...
                <li>A1- A2– B1 – B2-C1 + Foundation course (Studien Kollege)</li>
                <li>No tuition fees in Bachelor programme</li>
                <li>Pay only for foundation course</li>
                <li>Block account - 10332 EURO</li>
                <li>The admission in German taught programme is guaranteed in Bechelors.</li>
            </ul>
