...
const academicCalenderData = {
    ...
    content: {
        ...
        subTitle: "Important dates for MBBS admission at Batumi Shota Rustaveli State University",
        data: [["Events", "Dates"],
...
const eligibilityData = {
    ...
    content: {
        ...
        subTitle: "Eligibility Criteria for MBBS in Batumi Shota Rustaveli State University for Indian students",
...
const BatumShotaRustaveliStateUniversity = () => {
    const callBtnFnc=()=>{
...
" />
                ...
                <link rel="alternate" href="https://www.edurizon.in/study-destinations/study-mbbs-in-georgia/batum-shota-rustaveli-state-university" hrefLang="en-in"/>
            ...
            <div className="flex flex-col gap-[2vw] mb-[1vw] py-[4vw] items-center pt-[20vw]  md:pt-[8vw]">
                ...
                <div className='bg-linenChosen flex flex-col md:flex-row gap-[3vw] items-center w-full text-black'>
                    <Image className='w-full md:w-[40.625vw] h-full' src={"/assets/Images/mbbs-in-georgia/batumi-shota-rustaveli.png"} alt='college Image' width={650} height={550}/>
                    <div className='relative mx-[6vw] md:mx-0 py-[4vw]'>
                        <h2 className='font-bold text-h3TextPhone md:text-h2Text leading-[120%] mb-[2vw] md:mb-[1.5vw]'>Batumi Shota Rustaveli State University</h2>
            ...
            <section className="mx-[6vw] md:mx-[12.5vw] pb-[10vw] md:pb-[4vw]">
                ...
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    ...
                    <li>The official language of Georgia is Georgian.</li>
                ...
                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">About Batumi Shota Rustaveli State University</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    <li><strong>6-Year MBBS Program:</strong> Batumi Shota Rustaveli State University offers a comprehensive MBBS program divided into 12 semesters.</li>
                    <li><strong>Internationally Recognized:</strong> The university is accredited by various global medical organizations, ensuring the quality of its programs.</li>
                    <li><strong>Practical and Innovative Learning:</strong> The university emphasizes hands-on learning and clinical experience, integrating modern technology and innovative methodologies.</li>
                    <li><strong>Global Perspective:</strong> Batumi Shota Rustaveli State University promotes a global perspective through international collaborations and partnerships.</li>
                    <li><strong>Multicultural Environment:</strong> Batumi, the university's location, is a vibrant and diverse city that provides a multicultural learning environment for students.</li>
                    <li><strong>Affordable Education:</strong> Batumi Shota Rustaveli State University is known for offering quality education at an affordable price.</li>
                </ul>
            </section>
                ...
                <div className="flex flex-col gap-[2vw] md:gap-[1vw] text-black">
                    <div>
                        ...
                        <ul className="list-disc list-outside pl-[2vw] md:pl-[1.5vw] text-smallTextPhone md:text-regularText  text-justify">
                            ...
                            <li>Modern Campus and Facilities: Batumi Shota Rustaveli State University Batumi has a modern campus equipped with advanced laboratories, simulation centers, and a library.</li>
            ...
            <section className="mx-[6vw] md:mx-[12.5vw] pb-[10vw] md:pb-[4vw]">
                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Batumi Shota Rustaveli State University - Mission</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    <li>The mission of Batumi Shota Rustaveli State University, Batumi, is to support and implement the values of the healthcare and medical education by promoting the highest scientific and ethical standards, initiate new learning methods, new instructional tools, and innovative management to continuously develop modern educational approaches in academia, in a strive improve the health of many peoples by training medical professionals.</li>
                    <li>Batumi Shota Rustaveli State University, Batumi, promotes a global vision by establishing multicultural teaching and research environment, based on the principles of excellence and continuous enhancement of the quality of teaching, research and clinical practice.</li>
                    <li>Batumi Shota Rustaveli State University acts as the active member of the global network, participating in global transfer of knowledge supporting implementation of joint educational programs and scientific, research projects, integration of faculty and students into the global educational and scientific arena and providing global career opportunities for graduates.</li>
                </ul>

                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Batumi Shota Rustaveli State University - Vision</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                ...
                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Batumi Shota Rustaveli State University - Values</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    <li>Embraces the innovative nature of science and invariably follows in its enlightened path moving forward</li>
                    <li>Advocates academic freedom as the universal and indispensable component of scientific endeavours</li>
...
<h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">MBBS Program in Batumi Shota Rustaveli State University</h3>
                <p className="text-smallTextPhone text-left md:text-regularText  md:mb-[1vw]">The duration of MBBS programme in Batumi Shota Rustaveli State University is for 6 years including 1 year internship.</p>

                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">MBBS intake in Batumi Shota Rustaveli State University</h3>
                <p className="text-smallTextPhone text-left md:text-regularText  md:mb-[1vw]">Intake: September/October</p>

                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Career Prospects in Batumi Shota Rustaveli State University</h3>
                <p className="text-smallTextPhone text-left md:text-regularText">Graduates of Batumi Shota Rustaveli State University are eligible to appear for global licensing exams like :-</p>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    <li>USMLE (USA)</li>
                    <li>PLAB (UK)</li>
                    <li>Next (India)</li>
                ...
                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Batumi Shota Rustaveli State University– Recognition</h3>
                ...
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    <li>Tuition fee: 5000 USD (YEARLY)</li>
                    <li>Hostel & Mess: 3300 USD (YEARLY)</li>
                </ul>
                ...
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                    ...
                    <li>Students are very well taken-care of during their entire stay in University.</li>
                    <li>24/7 basis security cover.</li>
                </ul>

                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">BATUMI - Library</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                ...
                <p className="text-smallTextPhone text-left md:text-regularText">Georgian currency is Georgian Lari (GEL)</p>
            </section>
            ...
            <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Batumi Shota Rustaveli State University initial admission Process</h3>
                ...
                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">Batumi Shota Rustaveli State University complete admission Process</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1vw] text-left md:text-regularText md:text-justify">
                ...
                <h3 className="text-h6TextPhone leading-[120%] md:text-h5Text text-left">How to reach BATUMI SHOTA RUSTEVELI STATE UNIVERSITY</h3>
                <ul className="text-smallTextPhone list-disc ml-[3vw] md:ml-[1.5vw] mb-[4vw] md:mb-[1?v] text-left md:text-regularText md:text-justify">
                    <li>Direct flight from New Delhi to Tbilisi, Georgia</li>
                    <li>Maximum 5 hours Air journey from India </li>
                    <li>Low and affordable air fare</li>
                    <li>Maximum 5 Hrs journey to BATUMI SHOTA RUSTEVELI STATE UNIVERSITY after reaching Tbilisi airport.</li>
                </ul>
            </section>
            </div>
        </>
...
export default BatumShotaRustaveliStateUniversity
