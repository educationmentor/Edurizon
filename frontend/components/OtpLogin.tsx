        ...
        <div className='flex flex-col gap-[3vw] md:gap-[1.5vw]'>
            ...
            {otpSent && (
                <input
                    ...
                    className='md:w-[30vw] h-[12vw] md:h-[3vw] text-black  text-regularTextPhone md:text-regularText md:text-white rounded-[12.5vw] md:rounded-[6.25vw] border border-dimgrayChosen dark:border-white focus:outline-none px-[1.5vw] bg-transparent placeholder:text-dimgrayChosen dark:placeholder:text-gray-400'
                    disabled={isLoading}
                />
            )}
            <button
