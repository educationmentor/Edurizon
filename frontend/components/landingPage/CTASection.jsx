...
const CTASection = () => {
    return (
        <div className="mx-[7.5vw] mb-[14.5vw] md:mb-[9vw] py-[10vw] md:py-0 px-[6vw] rounded-[10vw] md:rounded-[2.5vw] w-auto h-[52vw] md:h-[28.5625vw] font-poppins text-white flex md:flex-row gap-[8.625vw] bg-orangeChosen" >
            ...
            <div className='w-full md:w-[19vw] my-auto flex flex-col items-center gap-[4.5vw] md:gap-[1vw]'>
                <div className=' flex flex-row gap-[2vw] md:gap-[1.125vw] '>
                    <div className='pr-[2vw] md:pr-[0.4375vw] border-r-[.5vw] md:border-r-[.25vw] border-white'>
                        <span className='font-helvetica text-h5TextPhone md:text-h3Text w-[9.75vw] text-center'><p className='leading-[120%] m-0 font-bold'>2.5k+</p> <p className='text-mediumTextPhone md:text-h6Text leading-[140%]'>Success Stories</p></span>
                    </div>
