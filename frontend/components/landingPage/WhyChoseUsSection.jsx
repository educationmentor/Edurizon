  ...
  return (
    <div className='flex flex-col md:flex-row z-[10] items-center gap-[8vw] md:gap-[3.75vw] '>
        <div className=' w-[87.5vw] md:w-[46.5vw] z-[2] md:pl-[7.5vw]  mt-[10vw] md:mt-[4.75vw]'>
            <div className=' font-poppins z-[3] text-tinyTextPhone md:text-tinyText w-full md:w-[35.25vw]'>
                ...
                <h1 className='text-h4TextPhone md:text-h1Text font-helvetica leading-[120%] font-bold dark:text-white  '>Hey!!<br/>We are <span className='text-orangeChosen'>Edurizon</span></h1>
                </div>
