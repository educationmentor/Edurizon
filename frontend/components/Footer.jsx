                    ...
                    <div className="flex flex-col w-[20.1875vw] gap-[4vw] font-medium">
                        ...
                        <div className='flex flex-col gap-[1vw] text-center font-normal '>
                            ...
                            <div className='flex flex-row justify-center gap-[1vw]'>
                                <a>
                                <svg  style={{width:"2vw", height:"2vw"}} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg style={{width:"2vw", height:"2vw"}} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg style={{width:"2vw", height:"2vw"}} viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <rect style={{width:"4vw", height:"4vw"}} className='text-white dark:text-black' transform="translate(0.490234 0.816406)"/>
                                        </clipPath>
                                        </defs>
                                        </svg>
                                        </a>
