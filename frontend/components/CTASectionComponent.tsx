  ...
  return (
    <>
              ...
              <div id="freeConsultation" className={`${isHidden ? "opacity-0 z-[-10]" : "opacity-100 z-[10]"}  fixed  bottom-[5vh] w-full px-[4vw]  transition-all duration-100  pointer-events-none`} ref={freeConsultationRef}>
                ...
                <div className={` w-[14.375vw] h-[17.375vw] flex flex-col justify-center  rounded-[.625vw] border-[.125vw] border-orangeChosen  bg-linenChosen overflow-hidden transition-all duration-300 ease-in-out ${showChatBot ?"opacity-100 pointer-events-auto":"pointer-events-none opacity-0"}` }>
                ...
                <svg onClick={()=>setShowChatBot(!showChatBot)} className=" w-[2.5vw] h-[2.5vw] pointer-events-auto cursor-pointer mt-auto " viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
