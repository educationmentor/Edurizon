const WhoWeAreSection = () => {
    return(
        <div className=" text-black dark:text-white md:max-w-[1200px] md:w-[75vw] mx-[6vw] md:mx-auto my-[10vw] md:my-0 md:mt-[8vw]">
