...
const DescriptionComponent = ({ id,title1normal,title1orange,title2,content1,content2,imageAlt,imageSrc }: DescriptionComponentProps) => {
    return (
        <div id='description' className="flex md:flex-row flex-col-reverse gap-[6vw] md:gap-[5vw] mx-[6vw] md:mx-[12.5vw] ">
                  <div className="md:w-[37.625vw] flex flex-col gap-[8vw] md:gap-[2vw] my-auto">
                    <h3 className="text-h5TextPhone text-center md:text-left md:text-h3Text font-bold leading-[120%]">{title1normal}{" "}<span className="text-orangeChosen">{title1orange}</span>?</h3>
